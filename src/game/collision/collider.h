...
static inline void set_collision_policy_vs_tilemaps(ColliderComponent *collider,
...
static inline void set_collision_policy_vs_entities(ColliderComponent *collider,
    CollisionPolicy policy)
{
